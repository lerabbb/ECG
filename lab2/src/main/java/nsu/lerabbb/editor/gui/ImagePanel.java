...
public class ImagePanel extends JPanel implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    private MyFrame parentComponent;
    @Getter
     ...
     */
    public ImagePanel(JScrollPane scrollPane, JFrame parentComponent) throws Exception {
        if (scrollPane == null)
        ...
        this.parentComponent = (MyFrame) parentComponent;
    ...
    public void paint(Graphics g) {
        if (img == null) {
            ...
            g.drawImage(img, 4, 4, panelSize.width, panelSize.height, null);
            Graphics2D g2 = (Graphics2D) g;
            float[] dash = {5};
            BasicStroke dashedStroke = new BasicStroke(2, BasicStroke.CAP_BUTT, BasicStroke.JOIN_MITER, 5, dash, 0);
            g2.setStroke(dashedStroke);
            g2.drawRect(4,4, getPreferredSize().width, getPreferredSize().height);
            g2.dispose();
        }
    }
...
//	}
     ...
     */
    public Dimension getVisibleRectSize() {
