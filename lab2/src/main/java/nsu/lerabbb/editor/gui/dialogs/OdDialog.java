...
public class OdDialog extends JDialog implements ActionListener, ItemListener {
    ...
    public OdDialog(EditController controller){
        super(new Frame(), "Параметры упорядоченного дизеринга", Dialog.ModalityType.APPLICATION_MODAL);
        setResizable(false);
        Logger.getInstance().info("Ordered dithering settings dialog opened");
    ...
    private void initElements(){
        ...
        redGroup = new SliderGroup("Квантование красного цвета:", Utils.OD_QUANT_MIN, Utils.OD_QUANT_MAX);
        greenGroup = new SliderGroup("Квантование зеленого цвета:", Utils.OD_QUANT_MIN, Utils.OD_QUANT_MAX);
        blueGroup = new SliderGroup("Квантование синего цвета:", Utils.OD_QUANT_MIN, Utils.OD_QUANT_MAX);
...
//        JLabel label = new JLabel("Настройте параметры дизеринга");
    ...
    private void setElementsState(){
        redGroup.setValue(Config.getRedOdNum());
        greenGroup.setValue(Config.getGreenOdNum());
        blueGroup.setValue(Config.getBlueOdNum());
    }
    ...
    private void saveChanges() {
        Config.setRedOdNum(redGroup.getValue());
        Config.setGreenOdNum(greenGroup.getValue());
        Config.setBlueOdNum(blueGroup.getValue());
        Logger.getInstance().info("Ordered dithering settings dialog closed");
        this.setVisible(false);
        this.dispatchEvent(new WindowEvent(this, WindowEvent.WINDOW_CLOSING));
    }
